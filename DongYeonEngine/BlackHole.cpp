...
BlackHole::BlackHole()
{
    ...
    mBlackHoleImage = new Gdiplus::Image(L"resources/blackhole.png");
...
// LateUpdate (필요 시 사용)
void BlackHole::LateUpdate()
{
}

void BlackHole::Render(Gdiplus::Graphics& graphics)
{
    if (mBlackHoleImage == nullptr)
        return;
    ...
    bitmapGraphics.DrawImage(mBlackHoleImage, RectF(0, 0, imageWidth, imageHeight));
...
float BlackHole::GetPositionX()
{
    return mX;
}

float BlackHole::GetPositionY()
{
    return mY;
}
